    ...
    <main className="section-spacing">
      <div className="section-content">
        ...
        <section className="mb-8">
          <p className="text-base">Private IT Support ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, and protect your information when you visit our website or book our services.</p>
        </section>
        <section className="mb-8">
        ...
        <section className="mb-8">
          ...
          <p className="text-base">When you book through Calendly, their platform collects and processes your information under their own privacy policy. Please review <a href="https://calendly.com/privacy" className="underline text-blue-700" target="_blank" rel="noopener noreferrer">Calendly's Privacy Policy</a> for more details.</p>
        </section>
        <section className="mb-8">
        ...
        <section className="mb-8">
          ...
          <p className="text-base">You may request the following at any time by emailing <a href="mailto:victor@privateitsupport.com" className="underline text-blue-700">victor@privateitsupport.com</a>:</p>
          <ul className="list-disc list-inside ml-4 text-base">
        ...
        <section className="mb-8">
          ...
          <p className="text-base">We may update this Privacy Policy from time to time. When we do, we will revise the "Effective Date" at the top of this page. Significant changes will be communicated through this website.</p>
        </section>
        <section className="mb-8">
